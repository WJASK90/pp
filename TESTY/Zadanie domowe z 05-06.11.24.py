...
print(rok_1 - start) #zysk z całego roku z oprocentowania 7,5%
...
rok_2 = 32472.9648
print(rok_2 - start) #zysk z całego roku z oprocentowania 8%
...
print(rok_3 - start) #zysk z całego roku z oprocentowania 8,25%
